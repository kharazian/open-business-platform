    ...
    <div className="mx-auto flex min-h-[70vh] w-full max-w-md items-center">
      <Card>
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-5 text-2xl font-bold text-slate-950 dark:text-white">Sign in to your workspace</h1>
          <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">A clean auth screen that still lives inside the theme playground.</p>
        </div>
