...
V8 finalization is documented in `docs/V8_FINALIZATION.md`, and practical V8 validation is documented in `docs/V8_PRACTICAL_TESTING.md`. V9 is finalized in `docs/V9_FINALIZATION.md`. V10 operational app modeling follows `docs/V10_START_HERE.md` and `tasks/v10/README.md`.
