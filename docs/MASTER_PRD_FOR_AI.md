...
V8 finalization is documented in `docs/V8_FINALIZATION.md`, and practical V8 validation is documented in `docs/V8_PRACTICAL_TESTING.md`; V9 is active and follows `docs/V9_START_HERE.md` and `tasks/v9/README.md`.
