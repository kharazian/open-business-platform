...
Next concrete work should review and verify the whole system across V1-V6, then decide the next V6 hardening slice for server-side PDF generation, conditional/page-break controls, or PDF email attachments.
