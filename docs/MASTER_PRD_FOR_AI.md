...
- `src/app/src/features/dashboards`: dashboard summary/analytics clients, published dashboard directory and read-only slug viewer, permission-gated builder with keyboard/touch canvas reordering and bounded preview concurrency, dynamic navigation, and generic adapter registry/settings contract
