...
- `src/api/Modules/Dashboards`: saved dashboard definition, isolated live publication snapshots, bounded revision history/restore, publication/navigation, unique draft and published slugs, permission-filtered viewer/navigation APIs, generic adapter config validation, and audit logging
