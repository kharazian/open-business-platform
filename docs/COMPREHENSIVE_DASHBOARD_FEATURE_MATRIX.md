...
| Configured series charts | Add, remove, reorder, label, style, color, and axis for one to four metrics | Verified | Single and multi-series breakdown/trend charts honor bar/line/area display metadata in the shared preview/viewer renderer; combo charts use independent left/right scales. |
