...
- Richer charts, including vertical/horizontal grouped, stacked, and 100% stacked Bar series, deterministic category ordering, Top-N plus Other grouping, responsive legend placement, bounded data-label content/placement, automatic/fixed K/M/B display units, and bounded axis titles/manual scaling
