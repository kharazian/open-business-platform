...
4. **Appearance and color controls — implemented**
   - Theme-safe palette presets, per-series semantic colors, responsive top/bottom/left/right legends, labels, gridlines, card accent, number/currency/percent formatting, deterministic breakdown category ordering, and bounded axis titles/manual maxima with clipping disclosure
